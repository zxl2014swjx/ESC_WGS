...
#    my $varscan2_somatic = $snv_varscan2_dir . '/' . $sample . '.somatic';
    ...
    my $snv_sh = $sample_dir . '/' . $sample . '.1Mcnv.sh';
...
=cut    
    ...
    my $cnv_Control_FREEC_dir = $cnv_dir . '/Control_FREEC_1M';
    ...
    print SNVSH "perl /mnt/X500/farmers/zhaogf/Project/PanCancer_Cheng/Gastric_WGS/latitude/control-freec/control_freec-config-1M.pl -c $cancer_recal_mpileup -n $normal_recal_mpileup -o $cnv_Control_FREEC_dir -s $sample_gender -f $control_freec_config\n";
